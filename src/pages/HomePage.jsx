  ...
  const testimonials = [
    {
      name: 'أحمد محمد',
      role: 'مريض',
      content: 'خدمة ممتازة وسهولة في الحجز. الأطباء محترفون والمتابعة ممتازة.',
      rating: 5
    },
    {
      name: 'د. فاطمة علي',
      role: 'طبيبة أطفال',
      content: 'منصة رائعة تساعدني في إدارة مواعيدي ومتابعة مرضاي بكفاءة.',
      rating: 5
    },
    {
      name: 'سارة أحمد',
      role: 'مريضة',
      content: 'بنك الدم ساعدني في العثور على متبرع في وقت قياسي. شكراً لكم.',
      rating: 5
    }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              تجارب حقيقية من مستخدمي منصة صحتك في أمان
            </p>
          </div>
