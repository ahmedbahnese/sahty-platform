...
export default function NursingDashboardPage() {
  ...
  const [form, setForm] = useState({ service_type: 'زيارة تمريض منزلية', address: '', description: '', scheduled_at: '', patient_id: '' })
  ...
  const createRequest = async event => {
    ...
    setForm({ service_type: 'زيارة تمريض منزلية', address: '', description: '', scheduled_at: '', patient_id: '' })
